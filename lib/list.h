...
//nodo di lista
typedef struct list {
	const void* payload;	   // oggetto nella lista
...
void  addElement(list_t* list, const void* element);  // aggiunge in fondo un elemento
int removeElement(list_t* list, const void* element); // rimuove un elemento dalla lista
